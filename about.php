...
var Page = {
	setup:function(){
		XU.centerElement('contentDiv', 'b', 0, 20);
	}
}
...
<div class="header glass">
  <h1 onclick="location.href='index.php'" style="cursor:hand;">footPrints</h1>
</div>

<div id="contentDiv" style="position:absolute;width:50%;" class="glass2">
	<center>
    <h3>what is footPrints?</h3>
    <hr>
      <p style="color:rgba(255, 255, 255, 0.5);">
        footPrints is a service that will allow you to search your or someone you know's digital footprint through Twitter or Instagram. 
        It will search all public posts of someone's username and then display on Google Maps
        where each post occured and the post based on each picture or post's metadata.
        You can search Twitter, Instagram or both at the same time.
      </p>
    <br>
    <h3>who we are</h3>
    <hr>
    <p style="color:rgba(255, 255, 255, 0.5);">
      Don Andreas - Testing<br>
      Dustin Bridges - Research and API's<br>
      Gavin Delphia - Coder and Team Lead<br>
	    Alex Thomson - Research and Presentation
    </p>
    <br>
    <h3>documentation</h3>
    <hr>
    <p style="color:rgba(255, 255, 255, 0.5);">
    	Frosted CSS Effect - http://codepen.io/Matori/pen/JFzok<br>
    	Twitter Oath API - [Abraham Williams](https://twitter.com/abraham)<br>
    	Earth Image - http://wallpaperhd.eu/wallpapers/planet_earth-1920x1080.jpg<br>
    </p>
	</center>
</div>
